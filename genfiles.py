...
def convert_annotation(image_id):
    in_file = open('/home/richardchen123/Documents/data/YOLOv4_data/VOCdevkit/VOC2007/Annotations/%s.xml' % image_id)
    out_file = open('/home/richardchen123/Documents/data/YOLOv4_data/VOCdevkit/VOC2007/labels/%s.txt' %image_id, 'w')
...
wd = "/home/richardchen123/Documents/data/YOLOv4_data/"
work_space_dir = os.path.join(wd, "VOCdevkit/")
if not os.path.isdir(work_space_dir):
    os.mkdir(work_space_dir)
work_sapce_dir = os.path.join(work_space_dir, "VOC2007/")
